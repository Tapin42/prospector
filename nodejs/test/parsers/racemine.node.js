...
describe('Racemine.com parser', function () {
    ...
    describe('readBib', function () {
        ...
        it('should have the three breakdown groups, with valid values', function () {
            ...
            expect(json.groups.ageGroup.url).to.equal('http://georesults.racemine.com/USA-Productions/events/2016/Oakland-Triathlon-Festival/search?q=&SearchDivision=INT-AGE%20GROUP&SearchGender=M&SearchAgeGroup=M%2040-44');
